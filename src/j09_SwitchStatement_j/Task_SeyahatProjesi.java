   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        double bakiye = 1000, Frankfurtbr = 60 / 20 * 5, kolnbr = 80 / 20 * 5;

        switch (hedef) {
            case "FRANKFURT":
                System.out.println("rotanız " + hedef + "ücret" + Frankfurtbr * kisi + "bakiyeniz:" + (bakiye -= Frankfurtbr * kisi));


            case "KÖLN":
                System.out.println("rotanız " + hedef + "ücret" + kolnbr * kisi + "bakiyeniz" + (bakiye -= kolnbr * kisi));

                break;
            default:
                System.out.println("hatalı yer seçimi yaptınız ");
        }
