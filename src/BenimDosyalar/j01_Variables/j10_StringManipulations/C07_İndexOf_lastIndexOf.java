...
public class C07_İndexOf_lastIndexOf {
    ...
    /* indexOf( * char karakter ya da String metnin kacinci indexden basladigini veren bir method dur. Sonuc integer dir.
    * Bu method index'i sorulan char'in String icindeki ilk gorunumunun index'ini return eder
     ...
     */
        String str = "Good";
        System.out.println("ilk görünen o nun yeri index nosu:" + str.indexOf('o'));//1
        System.out.println("  d nun  yeri index nosu:" + str.indexOf("d"));//3
        System.out.println("  d nun  yeri index nosu:" + str.indexOf("D"));//-1 -->D karakteri olmadıgı için
        // TRICK--> olmayan karakteri indexi sorgulanırsa -1 return eder
