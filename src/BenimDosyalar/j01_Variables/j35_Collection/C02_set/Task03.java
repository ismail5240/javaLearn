package BenimDosyalar.j01_Variables.j35_Collection.C02_set;
...
public class Task03 {
    public static void main(String[] args) {
            ...
            /*
                 ...
                 rtak değerleri ArrayListe ekleyiniz.
                 çıktı:  "Germany" , "Brazil" ,"USA"
                 ArrayListi yazdırınız.
             */

        HashSet<String> hs1 = new HashSet<>(Arrays.asList("Germany", "Türkiye", "Sout Africa", "Brazil", "USA"));
