package BenimDosyalar.j01_Variables.j11_MetodCreation;
...
public class C03_MethodOverloading {
    ...
    Java'da  methodlarin farkli olup olmadiklarini  icin
     ...
     b)parametreler kontrol edilir..
      ...
      TRICK_03 : Overloading "Compile Time Error"
...
public static void topla(int sayi1,int sayi2) {
    System.out.println("int-int type metohod çalıştı ->" + (sayi1+sayi2));
}
    public static void topla(double sayi1,int sayi2) {
        System.out.println("double-int type metohod çalıştı ->" + (sayi1+sayi2));
    }
    public static void topla(int sayi1,double sayi2) {
        System.out.println("int-double type metohod çalıştı ->" + (sayi1+sayi2));
        }
    public static void topla(double sayi1,double sayi2) {
        System.out.println("double-double type metohod çalıştı ->" + (sayi1+sayi2));
    }
