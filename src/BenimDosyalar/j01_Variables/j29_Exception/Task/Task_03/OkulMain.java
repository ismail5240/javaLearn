package BenimDosyalar.j01_Variables.j29_Exception.Task.Task_03;
...
public class OkulMain {
    public static void main(String[] args) {
        ...
        Scanner okuInt = new Scanner(System.in);// scanner class string sonrası döngüde hata verdiği için
        do {
